...
\midrule
\midrule 
\multirow{2}{*}{{\footnotesize{}Durchsuchen}} & {\footnotesize{}Breitensuche} & {\footnotesize{}$\mathcal{O}\left(\text{Adj.}\right)$} & {\footnotesize{}Laufzeit je nach Adjazenzstruktur} & {\footnotesize{}\vref{BFS}}\tabularnewline
\cmidrule{2-5} 
 & {\footnotesize{}Tiefensuche} & {\footnotesize{}$\mathcal{O}\left(\text{Adj.}\right)$} &  & {\footnotesize{}\vref{DFS}}\tabularnewline
\midrule 
{\footnotesize{}Topologische Sortierung} & {\footnotesize{}Topsort} & {\footnotesize{}$\mathcal{O}\left(\text{Adj.}\right)$} & {\footnotesize{}findet auch Kreise} & {\footnotesize{}\vref{TopSort}}\tabularnewline
\midrule 
{\footnotesize{}Komponenten finden} & {\footnotesize{}StrongComponents} & {\footnotesize{}$\mathcal{O}\left(\text{Adj.}\right)$(?)} &  & {\footnotesize{}\vref{StrongComponents}}\tabularnewline
\midrule 
\multirow{8}{*}{{\footnotesize{}Minimum Spanning Tree}} & {\footnotesize{}Boruvka} & {\footnotesize{}¯\textbackslash{}\_($\ddot{\smile}$)\_/¯} & {\footnotesize{}paralleler Ansatz} & {\footnotesize{}\vref{Boruvka}}\tabularnewline
\cmidrule{2-5} 
 & {\footnotesize{}Kruskal} & {\footnotesize{}$\mathcal{O}\left(E\log V\right)$} & {\footnotesize{}Kanten sortieren} & {\footnotesize{}\vref{Kruskal}}\tabularnewline
\cmidrule{2-5} 
 & \multirow{5}{*}{{\footnotesize{}Prim}} & {\footnotesize{}$-$} & {\footnotesize{}baut MST von Startknoten} & {\footnotesize{}\vref{Prim}}\tabularnewline
\cmidrule{3-5} 
...
\cmidrule{2-5} 
 & {\footnotesize{}Round Robin} & {\footnotesize{}$\mathcal{O}\left(E\log\log V\right)$} & {\footnotesize{}baut MST von überall} & {\footnotesize{}\vref{RoundRobin}}\tabularnewline
\midrule 
{\footnotesize{}1-Baum} & {\footnotesize{}OneTree} & {\footnotesize{}-> MST} & {\footnotesize{}Untere Schranke TSP} & {\footnotesize{}\vref{OneTree}}\tabularnewline
\midrule 
\multirow{2}{*}{{\footnotesize{}Maximales Branching}} & {\footnotesize{}Branching} & {\footnotesize{}$\mathcal{O}\left(A\log V\right)$} &  & {\footnotesize{}\vref{Branching}}\tabularnewline
 &  & {\footnotesize{}oder $\mathcal{O}\left(V^{2}\right)$} & {\footnotesize{}Schrumpfen:} & {\footnotesize{}\vref{Branching (Schrumpfen)}}\tabularnewline
\midrule 
\multirow{5}{*}{{\footnotesize{}Kürzeste Wege}} & \multirow{3}{*}{{\footnotesize{}Dijkstra}} & {\footnotesize{}$\mathcal{O}\left(V^{2}\right)$} & \multirow{3}{*}{{\footnotesize{}Keine neg. Kanten}} & \multirow{3}{*}{{\footnotesize{}\vref{Dijkstra}}}\tabularnewline
...
\cmidrule{2-5} 
 & {\footnotesize{}DAGShortestPath} & {\footnotesize{}$\mathcal{O}\left(V+A\right)$} & {\footnotesize{}Nur in DAGs} & {\footnotesize{}\vref{DAGShortestPath}}\tabularnewline
\midrule 
...
\midrule 
\multirow{2}{*}{{\footnotesize{}Minimales Matching}} & {\footnotesize{}Ungarische Methode} & {\footnotesize{}$\mathcal{O}\left(n^{3}\right)$} &  & {\footnotesize{}\vref{HungarianMethod}}\tabularnewline
\cmidrule{2-5} 
 & {\footnotesize{}AKP-Algorithmus} & {\footnotesize{}$\mathcal{O}\left(n^{3}\right)$} &  & {\footnotesize{}\vref{AKP}}\tabularnewline
\midrule 
\multirow{6}{*}{{\footnotesize{}Maximaler $\left(s,t\right)$-Fluss}} & {\footnotesize{}FordFulkerson} & {\footnotesize{}$\mathcal{O}\left(A\left|f^{*}\right|\right)\cancel{\boxast}$} & {\footnotesize{}a.W. im reduzierten Netzwerk} & {\footnotesize{}\vref{FordFulkerson}}\tabularnewline
\cmidrule{2-5} 
...
\midrule 
\multirow{3}{*}{{\footnotesize{}Minimaler Schnitt}} & \multirow{2}{*}{{\footnotesize{}NagamochiIbaraki}} & {\footnotesize{}$\mathcal{O}\left(V^{3}\right)$} & \multirow{2}{*}{{\footnotesize{}legale Ordnung}} & \multirow{2}{*}{{\footnotesize{}\vref{NagamochiIbaraki}}}\tabularnewline
...
\midrule 
\multirow{6}{*}{{\footnotesize{}Netzwerkfluss}} & {\footnotesize{}SteppingStone} & {\footnotesize{}¯\textbackslash{}\_($\ddot{\smile}$)\_/¯} &  & \tabularnewline
\cmidrule{2-5} 
...
\item Enthält $D^{\prime}$ negative Kreise, \emph{Stop}(\glqq Algorithmus
nicht anwendbar``)
...
\item Beschreibt $x^{i}$ eine Zuordnung, \emph{Stop}(\glqq Zuordnung optimal``)
...
\item Alle Zeilen ohne unabhängige Null erhalten die Markierung \glqq ($-$)``.
...
\item Falls $F_{i}$ dual zulässig und $F_{i}^{S}$ leer ist, \emph{Stop}(\glqq $F_{i}$
...
$F_{m}^{\ast}$ ist anschaulich die Komponente, die \glqq umgehängt``
wurde.
...
\item Falls kein augmentierender $\left(s,t\right)$-Weg existiert, \emph{Stop}(\glqq $f$
...
(Ein Präfluss ist also ein Fluss, der statt der Flusserhaltung \glqq $\text{Flow-In}=\text{Flow-Out}$``
nur die Bedingung \glqq $\text{Flow-In}\geq\text{Flow-Out}$`` erfüllen
muss.)
\begin{defn}
...
\item Enthält $D_{f}$ keinen negativen Kreis, dann \emph{Stop}(\glqq $f$
...
erreicht, \emph{Stop}(\glqq Problem unlösbar``).
